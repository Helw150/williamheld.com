...
export default class BlogIndex extends React.Component {
  static metadata() {
    return {
      title: 'Blog',
      description: 'Expression through the written word',
    };
  }
      ...
      <div className="">
        <Helmet
          ...
          meta={[
            ...
            { property: 'og:image', content: 'pages/images/wbh-logo.png' },
          ...
          <Grid>
            ...
            <div className="community-header-copy">
              <Col lg={6} lgOffset={3} md={6} mdOffset={3} sm={6} smOffset={3} xs={6} xsOffset={3} className="community-copy-wrapper">
                <h3 className="community-index-description">{BlogIndex.metadata().description}</h3>
              </Col>
            </div>
